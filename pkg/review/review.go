...
type Review struct {
	...
	Star      int       `json:"rev_star,omitempty" gorm:"column:rev_id;not null"`
	Title     string    `json:"rev_title,omitempty" gorm:"column:rev_id;not null"`
	Body      string    `json:"rev_body,omitempty" gorm:"column:rev_id;not null"`
